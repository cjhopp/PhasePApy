...
class FBPicker:
    ...
    def __init__(self, t_long=5, freqmin=1, corner=1, perc_taper=0.1,
                 mode='rms',
                 t_ma=20, nsigma=6, t_up=0.78, nr_len=2, nr_coeff=2, pol_len=10,
...
class FBSummary():
    ...
    def __init__(self, picker, tr):
        ...
        self.cf = Ratio(self.tr, self.picker.t_long, self.picker.freqmin,
                        self.cnr, self.perc_taper, self.picker.statistics_mode)
    ...
    def plot_bandfilter(self):
        ...
        title = '{0} {1} {2}'.format(self.stats.station, self.stats.channel,
        ...
        for i in range(n_bands):
            ...
            ax.text(0.5, 0.8, subtitle, horizontalalignment='center',
